...
from src.algorithms.fair_rank.core.knn_fair_rank_b import KNNFairRankMagnitude
from src.algorithms.fair_rank.core.knn_fair_rank_c import KNNFairRankCV, _SCORERS
